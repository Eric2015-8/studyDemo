...
class CreateSaleAccountWizard1(models.TransientModel):
    """手机创建销售账单 向导 """
    _name = "jc_finance.create.sale.account.wizard1"
    _description = u'手机创建销售账单的向导'
    ...
    def _add_detail(self):
        ...
        self.env['jc_finance.create.sale.account.detail.wizard2'].create(values)
...
class CreateSaleAccountWizard2(models.TransientModel):
    """手机创建销售账单 向导-明细 """
    _name = "jc_finance.create.sale.account.detail.wizard2"
    _description = u'手机创建销售账单的向导-明细'

    detail_id = fields.Many2one('jc_finance.create.sale.account.wizard1', string='引用', required=True,
