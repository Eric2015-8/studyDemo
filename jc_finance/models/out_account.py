...
class OutAccount(jc_base.Bill):
    _name = 'jc_finance.out_account'
    _description = u'财务：转出款单'
    _order = 'id desc'
    ...
    detail = fields.One2many('jc_finance.out_account_detail', 'out_account_id', string=u'转出款单明细', copy=True)
    ...
    def default_get(self, fields_):
        res = super(OutAccount, self).default_get(fields_)
